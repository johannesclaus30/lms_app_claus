...
<div class="container my-5 border border-2 rounded-3 shadow p-4 bg-light">
  ...
  <form method="POST" action="" novalidate>
    ...
    <div class="mb-3">
      ...
      <input type="date" value="<?php echo isset($data['author_birthday']) ? date('Y-m-d', strtotime($data['author_birthday'])) : '' ?>" class="form-control" id="author_Bday" name="author_Bday" max="<?= date('Y-m-d') ?>" required>
    </div>
    <div class="mb-3">
